...
const categories: readonly Category[] = [
  {
    ...
    Icon: Armchair,
    panelClassName: 'from-[#174432] via-[#2D6F4E] to-[#92E4A4]',
    title: 'Furniture',
  },
  {
    badge: 'Clean + ready',
    ...
    Icon: CookingPot,
    panelClassName: 'from-[#2D4A2F] via-[#4F7A55] to-[#BDECD4]',
    title: 'Kitchenware',
  },
  {
    ...
    Icon: BookOpen,
    panelClassName: 'from-[#143827] via-[#385B48] to-[#A4F5A6]',
    title: 'Books + media',
  },
  {
    badge: 'Check sizes',
    ...
    Icon: Baby,
    panelClassName: 'from-[#274133] via-[#577E69] to-[#C7F5CF]',
    title: 'Kids + baby',
  },
  {
    ...
    Icon: Wrench,
    panelClassName: 'from-[#1C3A28] via-[#436B4D] to-[#9AE5AC]',
    title: 'Garden + tools',
  },
  {
    badge: 'Power checked',
    ...
    panelClassName: 'from-[#1D3028] via-[#315245] to-[#8EEA93]',
    title: 'Tech shelf',
  },
] as const
    ...
    <section className="bg-[#F7FBF4] px-6 py-20 sm:py-24" id="what-we-take">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 grid gap-[1.125rem] md:grid-cols-2 xl:grid-cols-3">
          {categories.map(({ Icon, badge, description, panelClassName, title }) => (
            <article
              className="overflow-hidden rounded-[1.15rem] border border-[#CBD5E1] bg-white shadow-[0_18px_48px_rgba(11,51,34,0.06)]"
              key={title}
            >
              <div className={`relative h-28 bg-gradient-to-br ${panelClassName}`}>
                <div className="absolute left-4 top-4 rounded-full bg-white/14 px-3 py-1 text-sm font-bold tracking-[0.04em] text-white backdrop-blur-sm">
                  {badge}
                </div>
                <div className="absolute inset-y-0 right-5 flex items-center">
                  <Icon className="h-10 w-10 text-white/85" />
                </div>
                <div className="absolute -bottom-8 left-8 h-20 w-20 rounded-full bg-white/12 blur-2xl" />
              </div>
