...
const BellIcon = ({ size = 20 }: { size?: number }) => (
  <svg width={size} height={size + 4} viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12.0881 17.3184C12.0881 19.0092 10.7047 20.3926 9.01384 20.3926C8.17354 20.3926 7.39473 20.0442 6.84136 19.4908C6.28799 18.9375 5.93958 18.1587 5.93958 17.3184" stroke="currentColor" strokeWidth="1.53713" strokeMiterlimit="10" />
  </svg>
)
