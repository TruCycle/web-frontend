...
export function Button({
  ...
  const variantClasses =
    variant === 'primary'
      ...
      : variant === 'highlight'
      ? 'rounded-[5px] bg-tc-shell-accent text-[#121212] outline outline-[2px] outline-tc-shell-accent outline-offset-[4px] ring-0 hover:bg-tc-shell-accentHover focus-visible:ring-[#94FF96]'
      : variant === 'danger'
